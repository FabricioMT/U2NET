...
final_input = os.path.join(os.getcwd(), 'output_geral' + os.sep + 'Input_Return' + os.sep)
final_output_bg = os.path.join(os.getcwd(), 'output_geral' + os.sep + 'Output_Removed_Background' + os.sep)
final_output_contours = os.path.join(os.getcwd(), 'output_geral' + os.sep + 'Output_Edges' + os.sep)
final_output_crop = os.path.join(os.getcwd(), 'output_geral' + os.sep + 'cropBoundingBox' + os.sep)

output_erros = os.path.join(os.getcwd(), 'output_geral' + os.sep + 'Erros' + os.sep)
