...
final_output_bg = os.path.join(os.getcwd(), 'input_folder' + os.sep + 'testes_models' + os.sep + 'main' + os.sep)
final_output_contours = os.path.join(os.getcwd(), 'input_folder' + os.sep + 'testes_models' + os.sep + 'main2' + os.sep)
final_input = os.path.join(os.getcwd(), 'input_folder' + os.sep + 'testes_models' + os.sep + 'input' + os.sep)
